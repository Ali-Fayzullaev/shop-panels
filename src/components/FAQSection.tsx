...
const faqData = [
  ...
  },
  {
    ...
    answer: "Мы осуществляем доставку товаров в любой регион России, где есть транспортное сообщение, доставка рассчитывается индивидуально в соответствии с тарифами транспортных компаний. Для уточнения стоимости доставки или по вопросу самовывоза вы можете связаться с нашими менеджерами по телефону +7 (993) 702-17-64"
  },
  {
    id: 8,
    question: "Где можно посмотреть образцы панелей?",
    answer: "Вы можете посмотреть образцы в нашем шоуруме по адресу г. Москва, ТЦ галерея ремонта, МКАД 47 км. Или в главном офисе по адресу ТЦ Декоратор, Рязанский проспект 2, корп. 3, этаж 2."
  }
];
